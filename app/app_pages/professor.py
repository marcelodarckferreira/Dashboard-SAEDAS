...
def page_professor():
    ...
    if set(map(str, current_sidebar_escolas)) != set(map(str, prev_sidebar_escolas)):
        ...
        st.session_state["escola_table_selection_professor__selected_values"] = current_sidebar_escolas
    ...
    render_metric_cards([
        {"label": "TOTAL DE ATENDIMENTOS DE PROFESSOR", "value": total_atend},
    ...
    if df_cmp_urg is not None:
        ...
        aggrid_response = render_saedas_aggrid(
            ...
            key=f"urg_table_professor_{hash(str(current_selected_urgs))}",
