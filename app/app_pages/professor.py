...
.home-metric-label {
    ...
    if df_cmp_urg is not None:
        ...
        _urg_key_changed = st.session_state.get("_prev_urg_table_key_professor") != urg_table_key
    ...
    if df_aluno.empty:
        ...
        if df_aluno_filtrado.empty:
            ...
            if not df_aluno_para_exibir.empty:
                ...
                with st.container(key="professor_aluno_actions_toolbar"):
                    render_table_toolbar(df_aluno_head, "detalhes_alunos_professor.csv", "aluno_table_professor")
