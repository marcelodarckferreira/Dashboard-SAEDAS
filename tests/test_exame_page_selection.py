...
def test_exame_top_table_uses_sidebar_filtered_data():
    source = Path("app/app_pages/exame.py").read_text(encoding="utf-8")
    ...
    calls = [
        ...
        and any(
            ...
            and arg.value == "Principais Exames por URG"
...
def test_exame_top_table_does_not_enable_row_selection():
    source = Path("app/app_pages/exame.py").read_text(encoding="utf-8")
    tree = ast.parse(source)
